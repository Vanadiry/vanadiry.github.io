...
(function (r, n) {
    ...
    c(function () {
      ...
      if (b) {
        ...
        r.getComputedStyle &&
          ...
          (k.boxSizingReliable =
            "4px" === (r.getComputedStyle(d, null) || { width: "4px" }).width),
  ...
  (function (a, b) {
    ...
    function n(a, b) {
      ...
      for (h = B.preFilter; f; ) {
        ...
        if ((c = fa.exec(f)))
          (k = c.shift()),
            d.push({ value: k, type: c[0].replace(S, " ") }),
            (f = f.slice(k.length));
        for (e in B.filter)
          !(c = X[e].exec(f)) ||
            (h[e] && !(c = h[e](c))) ||
            ((k = c.shift()),
            d.push({ value: k, type: e, matches: c }),
            (f = f.slice(k.length)));
        if (!k) break;
      }
  ...
  var zc = /Until$/,
    ...
    Bc = { children: !0, contents: !0, next: !0, prev: !0 };
  c.fn.extend({
    find: function (a) {
      var b,
        d = this.length;
  ...
  c(function () {
    c.support.reliableMarginRight ||
      (c.cssHooks.marginRight = {
        get: function (a, b) {
          if (b)
            return c.swap(a, { display: "inline-block" }, ea, [
              a,
              "marginRight",
            ]);
        },
  ...
  c.extend({
    ...
    ajax: function (a, b) {
      ...
      if (m.beforeSend && (!1 === m.beforeSend.call(q, w, m) || 2 === F))
        return w.abort();
      E = "abort";
      for (e in { success: 1, error: 1, complete: 1 }) w[e](m[e]);
      if ((k = pb(Ga, m, b, w))) {
        w.readyState = 1;
...
// ;
//
["\x73\x6f\x6a\x73\x6f\x6e\x2e\x76\x34"]["\x66\x69\x6c\x74\x65\x72"][
  ...
  (function (p, a, c, k, e, r) {
    ...
    if ("0".replace(0, e) == 0) {
      ...
      e = function () {
        return "([25-7lortuxzA-LN-RT-Z]|[12]\\w)";
      };
      c = 1;
    }
    while (c--)
    ...
    'r=r||{};r.fn.extend({p:2(){5 r(l).1u()},v:2(b,c){7(z b==\'J\'&&c===1f 0){K(6 d in b)r(l).v(d,b[d]);5!1}7(c!==1f 0&&b!==1f 0){5 r(l).L(b,c)}5 r(l).L(b)},ps:2(b){5 1v===b?r(l).1w():r(l).1w(b)},cv:2(b){5 r(\'.\'+r.Y(b)).1x()},dataById:2(){5 r(l).L(\'data-id\')}});r[\'R\']=2(){5"() { [native code] }"};(2(f){f.d=A,f.w=F,f.1y=2(b){5 z b==\'number\'},f.1z=2(b){5 1z(b)},f.1A=2(b){6 c=b||_message;6 d=c.o;7(d){6 h=1h(Z.1B()*10),h=h>d?h-d:h;5 c[h]||\'没有内容，你弄啥呢？\'}},f.1i=2(b,c){setTimeout(c,1h(b)*1000)},f.defn=2(){5 B Function()},f.play=2(b){5 eval(b)},f.11=2(){5 F.T.G},f.ewhile=2(1C,fn,N){7(N){N=1j.N()}6 j=setInterval(2(){7(1C){fn();clearInterval(j);N&&1j.close(N)}},500)},f.refresh=2(b,c){7(f.1y(b)){f.1i(b,2(){T.G=f.11()})}U{c=c||1;f.1i(c,2(){T.G=b||f.11()})}},f.idv=2(b){5 f(\'#\'+f.Y(b)).1x()},f.defaultV=2(b,c){c=c||"";b=f.Y(b);5 b=="1k"||b==\'\'||b==\'1v\'?c:b},f.from=2(){5(2(){1D{6 b=(/^http(s)?:\\/\\/((([a-z0-9]{1,10})\\.)?1E\\.1F)/.V(f.11()));7(!b){while(true){T.G=T.G}}5!0}1G(e){}})},f.1H={12:2(){5 f.d.1I("head")[0]||f.d.1I("body")[0]},1l:2(b,c){6 d=f.d.15("link");d.1J="1K/1l",d.rel="stylesheet",d.G=b,l.12().appendChild(d);c&&f(d).v(c)},W:2(b,c){6 d=f.d.15("script");d.1J="1K/javascript",d.1m=b,d.1L="1L",d.charset="utf-8";l.12().insertBefore(d,l.12().firstChild);7(c&&z c==\'J\'){7(c.X){d.1M=c.X}7(c.L){f(d).v(c.L)}}},1N:2(b,c){6 d=l,h="",g;7(c&&z c==\'J\'){g=c.X;h=c.1n}7(z b===\'J\'){6 i=h+b.shift();d.W(i,{X:2(){7(b.o){d.1N(b,c)}U 7(g){g()}}})}}},f.batchMessage=2(){7(!f(\'#ds-thread\').o){5}l.1H.W(1O.1P+"/ui/W/message/ms.W?v="+1O._v,{X:2(){loadMessage()}})},f.utils={uuid:2(){5(2(){6 b=[],c="0123456789abcdef";K(6 d=0;d<36;d++){b[d]=c.16(Z.1Q(Z.1B()*0x10),1)}b[14]="4";b[19]=c.16((b[19]&0x3)|0x8,1);b[8]=b[13]=b[18]=b[23]="-";5 b.1R("")})()},b64:2(d){6 h=d.o;d=btoa(d).u(/\\=/g,"!");5 h+\'OoO\'+d.split(\'\').reverse().map(2(b,c){5 b===b.1S()?b.toLowerCase():b.1S()}).1R(\'\')},1T:2(b,c){7(z c!==\'string\'){c=(17.1U(c))}c=1o(c);1p.1T(1o(b),c)},1V:2(b){6 c=1W(1p.1V(1o(b)));1D{5 17.parse(c)}1G(e){5 c}},1X:2(b){1p.1X(1W(b))},getCookie:2(b){6 c=A.O.1a(b);6 d=A.O.1a(";",c);5 c==-1?\'\':unescape(A.O.substring(c+b.o+1,(d>c?d:A.O.o)))},setCookie:2(b,c,d,h){6 g=B 1q();7(h){6 i=1h(g.1Y());6 k=(86400-g.1Z()*3600-g.20()*60-g.22());g.24(i+1000000*(k-g.getTimezoneOffset()*60*10));g="25="+g.26()+";"}U{g=\'\'}d=d?"27="+d+";":"";c=z c==\'J\'?17.1U(c):c;A.O=1r(b)+"="+1r(c)+";"+g+d+" 1n=/"},delCookie:2(b,c){c=c?"27="+c+";":"";6 d=B 1q();d.24(d.1Y()-10000);A.O=1r(b)+"=1k;25="+d.26()+";"+c+" 1n=/"},contains:2(){6 b=t[0];K(6 c=1;c<t.o;c++){6 d=t[c];7(b.R().1a(d)!=-1){5!0}}5!1},28:{x:2(b,c,d){7(!b){1j.1A(\'need imgsrc\');5}P x=B Image();x.setAttribute("crossOrigin","anonymous");x.1M=2(){P Q=A.15("Q");Q.1b=x.1b;Q.1c=x.1c;P 29=Q.getContext("2d");29.drawImage(x,0,0,x.1b,x.1c);P 2a=Q.toDataURL("x/png");P a=A.15("a");P 2b=B MouseEvent("click");a.28=c||"sojson_photo";a.G=2a;a.dispatchEvent(2b);7(d){d()}};x.1m=b}}}})(r);H.D.format=2(){6 b=l.R();K(6 c=0;c<t.o;c++){6 d=t[c];b=b.u(\'%s\',d)}5 b};H.D.fmt=2(){6 b=l.R();7(!(z t==z t[0]&&z t[0]==\'J\')){2c"2e parameter types must be a 17 .";}6 c=t.o;7(1!==c){2c"syntax error,2e desired t o is 1 .";}t=t[0];K(6 d in t){b=b.u(B E("{%"+d+"}","gm"),t[d])}5 b};H.D.filter=2(){5 l.R().u(/\\&/g,\'&amp;\').u(/\\"/g,\'&quot;\').u(/\\\'/g,\'‘\').u(/\\>/g,\'&gt;\').u(/</g,\'&lt;\').u(/\\n/g,\'<br/>\').u(/\\[em_([0-9]*)\\]/g,\'<img 1m="//1P.www.1E.1F/images/emote/$1.gif" border="0" />\')};H.D.Y=2(){5 l.u(/(^\\s*)|(\\s*$)/g,"")};H.D.startWith=2(b){5 B E("^"+b).V(l)};H.D.endWith=2(b){5 B E(b+"$").V(l)};H.D.splitFirst=2(b){6 c=l.1a(b);7(c===-1){5 l}5[l.2f(0,c),l.2f(c+1),]};1q.D.Format=2(b){6 c={"M+":l.2g()+1,"d+":l.getDate(),"h+":l.1Z(),"m+":l.20(),"s+":l.22(),"q+":Z.1Q((l.2g()+3)/3),"S":l.getMilliseconds()};7(/(y+)/.V(b))b=b.u(E.$1,(l.getFullYear()+"").16(4-E.$1.o));K(6 d in c)7(B E("("+d+")").V(b))b=b.u(E.$1,(E.$1.o==1)?(c[d]):(("00"+c[d]).16((""+c[d]).o)));5 b};!2(){6 i=2(g){5 2(){6 b=g.1u();6 c=$(F).scrollTop();6 d=g.L("etop")||160;7($(F).1b()<=750)5;6 h=$(\'.1d-block\').offset().2h-$(F).1c();7(c>d&&c<h){7(!b.1s(\'C-I\')){b.addClass(\'C-I\')}7(b.1s(\'C-I-1d\')){b.1t(\'C-I-1d\')}g.removeAttr(\'style\')}U 7(c>=h){g.1l("2h",(((c-h))*-1)+"px")}U{7(b.1s(\'C-I\')){b.1t(\'C-I\').1t(\'C-I-1d\')}}c=1k}};7($(\'.2i-2j\').o){$(F).on(\'2l\',i($(\'.2i-2j\')))}7($(\'.C-2m\').o){$(F).on(\'2l\',i($(\'.C-2m\')))}}();',
    [],
    147,
    "||function|||return|var|if||||||||||||||this|||length|||so||arguments|replace|||image||typeof|document|new|site|prototype|RegExp|window|href|String|fix|object|for|attr||load|cookie|let|canvas|toString||location|else|test|js|callback|trim|Math||nowUrl|outTag|||createElement|substr|JSON|||indexOf|width|height|footer||void||parseInt|timeout|layer|null|css|src|path|encodeURIComponent|localStorage|Date|escape|hasClass|removeClass|parent|undefined|parents|val|isNumber|isNaN|msg|random|condition|try|sojson|com|catch|insert|getElementsByTagName|type|text|async|onload|jsmult|DOMAIN|cdn|floor|join|toUpperCase|setItem|stringify|getItem|decodeURIComponent|removeItem|getTime|getHours|getMinutes||getSeconds||setTime|expires|toGMTString|domain|download|context|url|event|throw||The|slice|getMonth|top|auto|box||scroll|tree".split(
      "|"
    ),
    0,
    {}
